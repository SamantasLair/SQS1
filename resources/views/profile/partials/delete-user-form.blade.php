<section class="space-y-6">
    ...
    <x-modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
        <form method="post" action="{{ route('profile.destroy') }}" class="p-6 bg-gray-800 border border-white/10 rounded-lg">
            @csrf
            @method('delete')
            ...
            <div class="mt-6">
                ...
                <x-text-input
                    ...
                    name="password"
                    type="password"
                    class="mt-1 block w-3/4 bg-black/20 border-gray-600 text-white focus:border-red-500 focus:ring-red-500"
            ...
            <div class="mt-6 flex justify-end">
                <x-secondary-button x-on:click="$dispatch('close')" class="bg-gray-700 text-white hover:bg-gray-600 border-gray-600">
                    {{ __('Batal') }}
                </x-secondary-button>
