                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('quizzes.update', $quiz) }}" method="POST">
                        ...
                        <div>
                            ...
                            <input type="text" name="title" id="title" class="block mt-1 w-full rounded-md shadow-sm border-gray-300" value="{{ old('title', $quiz->title) }}" required>
                        </div>
                        <div class="mt-4">
                            <label for="description" class="block font-medium text-sm text-gray-700">Deskripsi (Opsional)</label>
                            <textarea name="description" id="description" rows="4" class="block mt-1 w-full rounded-md shadow-sm border-gray-300">{{ old('description', $quiz->description) }}</textarea>
                        </div>
                        <div class="mt-4">
